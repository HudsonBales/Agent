...
const agents = [
    {
        ...
        systemPrompt: "You are the Daily Brief agent. Provide crisp summaries with remediation recommendations when signals shift.",
...
const metrics = [
    {
        ...
        points: Array.from({ length: 10 }).map((_, idx) => ({
            timestamp: new Date(Date.now() - (9 - idx) * 86400000).toISOString(),
