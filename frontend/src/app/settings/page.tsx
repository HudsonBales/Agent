  ...
  return (
    <AppShell sessions={sessions} agents={agents}>
      <div className="mx-auto max-w-3xl space-y-6 px-6 py-8">
        <header>
          <p className="text-sm uppercase tracking-wide text-neutral-500">Fine tune everything</p>
          <h1 className="text-3xl font-semibold">Settings</h1>
          <p className="text-neutral-400">Workspace preferences, billing, and defaults.</p>
        </header>
